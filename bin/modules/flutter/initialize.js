...
// async function initialFlutterSetUp(projectDirPath) {
//   //  constants (full)
//   // helpers
//   // logging

//   const constantsDir = path.join(projectDirPath, "lib/constants");
//   await fs.mkdir(constantsDir, { recursive: true });

//   await fs.appendFile(
//     path.join(constantsDir, "app_constant.dart"),
...
// export default initialFlutterSetUp;
